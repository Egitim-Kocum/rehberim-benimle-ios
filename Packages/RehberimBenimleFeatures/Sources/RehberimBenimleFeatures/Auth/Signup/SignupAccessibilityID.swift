...
public enum SignupAccessibilityID {
    ...
    public static let confirmPasswordTextField = "signup_confirm_password_textfield"
    public static let signUpButton = "signup_button"
    public static let alreadyHaveAccountButton = "signup_already_have_account_button"
}
